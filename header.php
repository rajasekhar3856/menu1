              ...
              <ul class="sidebar-menu"> 
				<?php 
					...
					for($i=0;$i < $length_menu; $i++){
						...
						$selectm = mysqli_query($dbconn,"select * from menu where id =".$header_getmenu[$i]);//1,2,3,4,7,8,9,10,11
						while($getmenu = mysqli_fetch_array($selectm)){
							// $result_c = array_intersect($getmenu, $header_getmenu);
							if($getmenu['parent']==0){
											...
											while($getmenu1 = mysqli_fetch_array($selectm1)){
												?>
													<ul class="sub">
														...
														<li class="subli"><a class="suba" href="<?php echo $getmenu1['link']; ?>"><?php echo $getmenu1['label']; ?></a></li>
													</ul>
													<?php
												}
